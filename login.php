      ...
      <div id="login-form" class="card m-auto p-2">
        <div class="card-body">
          <form name="login-form" class="login-form" action="home.php" method="post" onsubmit="return validateCredentials();">
            <div class="logo">
        			<img src="images/doctor.jpg" class="profile"/>
              <h1 class="logo-caption"><span class="tweak">P</span>HARMA<span class="tweak">C</span>ARE</h1>
        			<h1 class="logo-caption"><span class="tweak">A</span>dmin<span class="tweak">L</span>ogin</h1>
        		</div> <!-- logo class -->
